...
namespace ManualMapInjection.Injection
{
    ...
    internal class LOAD_DLL_CONTEXT64
    {
        public IMAGE_DOS_HEADER dos_hdr;
        public IMAGE_NT_HEADERS64 hdr;

        public PIMAGE_SECTION_HEADER sect;
        public ulong file_offset_section_headers;
        public ulong size_section_headers;

        public ulong image_base;
        public IntPtr image;
        public List<IntPtr> loaded_import_modules_array;

        public LPDLLMAIN dll_main;
    }

    internal class LOAD_DLL_CONTEXT32
    {
        IMAGE_DOS_HEADER dos_hdr;
        IMAGE_NT_HEADERS32 hdr;

        PIMAGE_SECTION_HEADER sect;
        ulong file_offset_section_headers;
        ulong size_section_headers;

        ulong image_base;
        IntPtr image;
        List<IntPtr> loaded_import_modules_array;
    ...
    {
        //static ELoadDLLResult LoadDLL_LoadHeaders64(LOAD_DLL_CONTEXT64 ctx)
        //{
        //    if (!ctx.dos_hdr.isValid)
        //        return ELoadDLLResult.ELoadDLLResult_InvalidImage;
        //    if (!ctx.hdr.isValid || ctx.hdr.FileHeader.NumberOfSections == 0)
        //        return ELoadDLLResult.ELoadDLLResult_InvalidImage;
    ...
    internal class ManualMapInjector
    {
        ...
        private IntPtr LoadImageToMemory(IntPtr baseAddress)
        {
            ...
            var allocatedRemoteMemory = AllocateMemory(imageSize);
